...
What is very important when deciding for a visualization of your data?

![](images/data-science-explore.png){width=90%} 


To avoid the most of your trouble, the best suggestion is to have the data ready for your visualization to come to live. So that:

- import your data
- tidy the set in a way to have your variables ready to display
- transform the data as needed
- visualize them with a plot
- model 
- communicate
