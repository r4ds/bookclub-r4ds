...
```{r 21-venndiagram, echo=FALSE, fig.align='center', fig.cap='Venn diagram', out.width='100%'} 
...
```{r 21-09, message=FALSE, warning=FALSE, paged.print=FALSE}
top_dest <- flights %>%
...
```{r 21-semijoin2, echo=FALSE, fig.align='center', fig.cap='Semi-join', out.width='60%'} 
...
```{r 21, echo=FALSE, fig.align='center', fig.cap='Venn diagram', out.width='100%'} 
knitr::include_graphics("images/venn_diagram.png")
```

Suppose we have two tables with two variables: id and the observations
```{r 200, echo=FALSE, fig.align='center', fig.cap='Two tables', out.width='30%'} 
knitr::include_graphics("images/twotables.png")
```
...
```{r 21-duplicates, echo=FALSE, fig.align='center', fig.cap='Duplicates', out.width='60%'} 
knitr::include_graphics("images/duplicates.png")
```

2. Both tables have duplicate keys

```{r 21-duplicates2, echo=FALSE, fig.align='center', fig.cap='Duplicates', out.width='60%'} 
...
```{r 21-merge, echo=FALSE, fig.align='center', fig.cap='Implementations', out.width='60%'} 
knitr::include_graphics("images/merge.png")
```

SQL is the inspiration for dplyr’s conventions
```{r 21-sql,echo=FALSE, fig.align='center', fig.cap='Implementation', out.width='60%'} 
