...
```{r 19-03, echo=FALSE, fig.align='center', fig.cap='nycfilghts13 package', out.width='100%'} 
...
```{r 19-venndiagram, echo=FALSE, fig.align='center', fig.cap='Venn diagram', out.width='100%'} 
knitr::include_graphics("images/venn_diagram.png")
```

Suppose we have two tables with two variables: id and the observations
```{r 19-twotables, echo=FALSE, fig.align='center', fig.cap='Two tables', out.width='30%'} 
...
```{r 19-innerjoin, echo=FALSE, fig.align='center', fig.cap='inner join', out.width='100%'} 
...
```{r 19-outerjoins, echo=FALSE, fig.align='center', fig.cap='Outer joins', out.width='60%'} 
...
```{r 19-duplicates, echo=FALSE, fig.align='center', fig.cap='Duplicates', out.width='60%'} 
knitr::include_graphics("images/duplicates.png")
```

2. Both tables have duplicate keys

```{r 19-duplicates2, echo=FALSE, fig.align='center', fig.cap='Duplicates', out.width='60%'} 
...
```{r 19-merge, echo=FALSE, fig.align='center', fig.cap='Implementations', out.width='60%'} 
knitr::include_graphics("images/merge.png")
```

SQL is the inspiration for dplyr’s conventions
```{r 19-sql,echo=FALSE, fig.align='center', fig.cap='Implementation', out.width='60%'} 
...
```{r 19-semijoin, echo=FALSE, fig.align='center', fig.cap='Semi-join', out.width='60%'} 
knitr::include_graphics("images/semijoin.png")
```

```{r 19-09, message=FALSE, warning=FALSE, paged.print=FALSE}
top_dest <- flights %>%
...
```{r 19-semijoin2, echo=FALSE, fig.align='center', fig.cap='Semi-join', out.width='60%'} 
...
```{r 19-antijoin, echo=FALSE, fig.align='center', fig.cap='Anti-join', out.width='60%'} 
