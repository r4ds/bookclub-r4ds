...
```{r}
#| label: 15-special_missing_val_numeric
#| eval: false
...
```{r}
#| label: 15-checking_special_missing_val_numeric
#| eval: false
...
```{r}
#| label: 15-checking_memory_character
#| eval: false
...
```{r}
#| label: 15-atomic_vec_missing_value
#| eval: false
...
```{r}
#| label: 15-diff_finite_inifinite
#| eval: false
...
```{r}
#| label: 15-possible_values_numeric
#| eval: false
...
```{r}
#| label: 15-parse_integer_nonNumeric
#| eval: false
...
```{r}
#| label: 15-parse_numeric_nonNumeric
#| eval: false
...
```{r}
#| label: 15-implicit_coerce_logical_to_numeric
#| eval: false
...
```{r}
#| label: 15-implicit_coerce_numeric_to_logical
#| eval: false
...
```{r}
#| label: 15-coerce_vector_with_multiple_types
#| eval: false
...
```{r}
#| label: 15-adding_vectors_with_lengths_differ
#| eval: false
...
```{r}
#| label: 15-adding_vec_with_lengths_differ_not_multiple
#| eval: false
...
```{r}
#| label: 15-adding_cols_with_lengths_differ
#| eval: false
...
```{r}
#| label: 15-naming_vec_at_creation
#| eval: false
...
```{r}
#| label: 15-naming_vec_using_purrr
#| eval: false
...
```{r}
#| label: 15-subset_vec_positive_integers
#| eval: false
...
```{r}
#| label: 15-subset_vec_positive_integers1
#| eval: false
...
```{r}
#| label: 15-subset_vec_negative_integers
#| eval: false
...
```{r}
#| label: 15-subset_vec_positive_and negative_integers
#| eval: false
...
```{r}
#| label: 15-subset_named_vec_with_character_vec
#| eval: false
...
```{r}
#| label: 15-subset_named_vec_with_character_vec1
#| eval: false
...
```{r}
#| label: 15-ex20.4.1_is.na_is_is.finite
#| eval: false
...
```{r}
#| label: 15-ex20.4.2_is_vector_TRUE
#| eval: false
...
```{r}
#| label: 15-ex20.4.2_is_vector_FALSE
#| eval: false
...
```{r}
#| label: 15-ex20.4.2_is_atomic_attr
#| eval: false
...
```{r}
#| label: 15-ex20.4.3_set_names_fn_2
#| eval: false
...
```{r}
#| label: 15-ex20.4.3_set_names_fn_3
#| eval: false
...
```{r}
#| label: 15-ex20.4.3_set_names_fn_4
#| eval: false
...
```{r}
#| label: 15-ex20.4.3_set_names_fn_5
#| eval: false
...
```{r}
#| label: 15-ex20.4.3_set_names_fn_6
#| eval: false
...
```{r}
#| label: 15-ex20.4.3_setNames_fn_7
#| eval: false
...
```{r}
#| label: 15-lists_with_mix_objects
#| eval: false
...
```{r}
#| label: 15-subsetting_named_lists
#| eval: false
...
```{r}
#| label: 15-ex20.5.2_diff_lists_tibbles
#| eval: false
...
```{r}
#| label: 15-implementation_of_method_default
#| eval: false
...
```{r}
#| label: 15-implementation_of_method_numeric
#| eval: false
...
```{r}
#| label: 15-augmented_date_time_tzone
#| eval: false
...
```{r}
#| label: 15-augmented_date_time_POSIXlt
#| eval: false
...
```{r}
#| label: 15-ex20.7.2_2_tibbles_cols_diff_lengths
#| eval: false
...
```{r}
#| label: 15-ex20.7.3_lists_within_tibbles
#| eval: false
