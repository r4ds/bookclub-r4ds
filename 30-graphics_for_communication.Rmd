...
```{r 32-01,fig.cap="Credit:The Truthful Art, by Albert Cairo",fig.align='center', include=FALSE}
...
```{r 32-02,message=FALSE, warning=FALSE, include=FALSE, paged.print=FALSE}
library(tidyverse)
```
...
```{r 32-04,message=FALSE, warning=FALSE, paged.print=FALSE}
