...
```{r}
#| label: web_scraping-html_element
#| eval: false
...
```{r}
#| label: web_scraping-star_wars-section
...
```{r}
#| label: web_scraping-star_wars-directors
...
```{r}
#| label: web_scraping-star_wars-tibble
