...
-   What are Vectors and Why we talking about Logical Vectors
...
-   Combining logical vectors using Boolean algebra
    ...
    -   Venn Diagrams here shows the logical relations between logical vectors
...
-   There is an intermediate execution step that form the logical vectors behind the scene when you use `filter()`
