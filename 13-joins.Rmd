...
```{r 13-01, message=FALSE, warning=FALSE, include=FALSE, paged.print=FALSE}
library(nycflights13)
library(tidyverse)
```


```{r 13-02, eval=FALSE, include=T}
...
```{r 13-03, echo=FALSE, fig.align='center', fig.cap='nycfilghts13 package', out.width='100%'} 
...
```{r 13-venndiagram, echo=FALSE, fig.align='center', fig.cap='Venn diagram', out.width='100%'} 
knitr::include_graphics("images/venn_diagram.png")
```

Suppose we have two tables with two variables: id and the observations
```{r 13-twotables, echo=FALSE, fig.align='center', fig.cap='Two tables', out.width='30%'} 
...
```{r 13-innerjoin, echo=FALSE, fig.align='center', fig.cap='inner join', out.width='100%'} 
...
```{r 13-outerjoins, echo=FALSE, fig.align='center', fig.cap='Outer joins', out.width='60%'} 
...
```{r 13-duplicates, echo=FALSE, fig.align='center', fig.cap='Duplicates', out.width='60%'} 
knitr::include_graphics("images/duplicates.png")
```

2. Both tables have duplicate keys

```{r 13-duplicates2, echo=FALSE, fig.align='center', fig.cap='Duplicates', out.width='60%'} 
...
```{r 13-merge, echo=FALSE, fig.align='center', fig.cap='Implementations', out.width='60%'} 
knitr::include_graphics("images/merge.png")
```

SQL is the inspiration for dplyr’s conventions
```{r 13-sql,echo=FALSE, fig.align='center', fig.cap='Implementation', out.width='60%'} 
...
```{r 13-semijoin, echo=FALSE, fig.align='center', fig.cap='Semi-join', out.width='60%'} 
knitr::include_graphics("images/semijoin.png")
```

```{r 13-09, message=FALSE, warning=FALSE, paged.print=FALSE}
top_dest <- flights %>%
...
```{r 13-semijoin2, echo=FALSE, fig.align='center', fig.cap='Semi-join', out.width='60%'} 
...
```{r 13-antijoin, echo=FALSE, fig.align='center', fig.cap='Anti-join', out.width='60%'} 
