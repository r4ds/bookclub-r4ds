...
{{< revealjs "slides/99-25-many_models.html" >}}
:::
...
```{r}
#| label: 99-25-view-the-nested-dataframe
...
```{r}
#| label: 99-25-"un-nestw/.drop=true"
...
```{r}
#| label: 99-25-geom-jitter-plus-bad-r2
...
```{r}
#| label: 99-25-vectorized-functions
...
```{r}
#| label: 99-25-un-nested-list-of-vectors
...
```{r}
#| label: 99-25-chapter-21-code-example
...
```{r}
#| label: 99-25-refactored-using-mutate
...
```{r}
#| label: 99-25-mtcars-with-summarise
...
```{r}
#| label: 99-25-summarise-with-list
...
```{r}
#| label: 99-25-capture-probabilities
...
```{r}
#| label: 99-25-unnest-with-tibble
...
{{< video https://www.youtube.com/embed/lO_qtXM8OH8 >}}
...
{{< video https://www.youtube.com/embed/d5FPrn4vTzc >}}
...
{{< video https://www.youtube.com/embed/v1OawROf1ZQ >}}

{{< video https://www.youtube.com/embed/PX7y2jlRYuU >}}
