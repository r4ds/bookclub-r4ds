...
This companion is available at [r4ds.io/bookclub-r4ds](r4ds.io/bookclub-r4ds).
...
This one is actually being developed ahead of the club by a private group, so don't be confused if the book clubs don't know about this version!
...
- More information about how to present is available in the [github repo](https://github.com/r4ds/bookclub-URL).
