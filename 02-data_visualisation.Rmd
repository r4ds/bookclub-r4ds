...
=======
## Creating a ggplot: geom_*() {-}
>>>>>>> ec1eed4000bc217db4bf220eceda971d5563361c
...
- **Global options:** written in `ggplot()` and apply to all layers
- **Local options:** written in `geom_*()` and apply only to that layer.
...
Use `labs()` add understandable titles and axes.
...
Only difference mapping globally vs. locally, so they should look the same.
