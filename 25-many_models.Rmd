...
-   As your experience grows with Exploritory Data Analysis (EDA) you will find your models grow as well
...
Furthermore, we can thank Jenny Bryan for authoring hte gapminder package!

```{r, Load Gapminder, eval=FALSE}
library(gapminder)
gapminder
```
