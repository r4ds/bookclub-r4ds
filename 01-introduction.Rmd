...
- **Communicate:** 
    ...
    - ***Note:*** R4DS 2e focuses on [Quarto](https://quarto.org/), vs [RMarkdown](https://quarto.org/) in 1e
...
-   Numeric literacy & basic programming skills
...
-   The [**tidyverse**](https://tidyverse.tidyverse.org/) = collection of functions, data, & documentation 
